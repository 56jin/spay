...
public class DeductService {
    ...
    public Map<String, String> deductRealPayee(Map<String, String> parameters) throws Exception {
        ...
        // 生成请求明文
        String plaintext = TradeRequest.getSingleWithPayeeRequest(parameters);

        // 商户代码
        String merId = parameters.get("merId");

        // 服务代码单笔代扣为NCPS0001;
        String serviceCode = Constants.DEDUCT_REAL_PAYEE_SERVICE_CODE;
        ...
        try {
            ...
            if (verify) {
                ...
                DeductRealPayee deductRealPayee = mapper.convertValue(parameters, DeductRealPayee.class);
                deductRealPayee.create();
                ...
                deductRealPayee.setExecCode(execCode);
                deductRealPayee.setExecMsg(execMsg);
                deductRealPayee.setPaySerialNo(paySerialNo);
    ...
    public Map<String, String> deductRealPay(Map<String, String> parameters) throws Exception {
        ...
        // 服务代码单笔代扣为NCPS0001;
        String serviceCode = Constants.DEDUCT_REAL_PAY_SERVICE_CODE;
