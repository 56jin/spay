...
import business.Invests;
import business.Loans;
import business.Member;
import business.Repayment;
	...
	private static void excute(Map<String, String> params) {
		...
		if(flag){
				...
				if(P2pCommonUtils.isAsynchSoapNames(cmdId)){
					...
					String result = submitByAsynch(maps);  //异步提交至P2P
